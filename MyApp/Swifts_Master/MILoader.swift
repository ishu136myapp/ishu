...
extension MILoader {
    ...
    private func resizeActivityIndicator() {
        ...
        NSLayoutConstraint(item: MILoader.activityIndicator, attribute: .centerX, relatedBy: .equal, toItem: CAppdelegate?.window, attribute: .centerX, multiplier: 1.0, constant: 0.0).isActive  = true
        
        NSLayoutConstraint(item: MILoader.activityIndicator, attribute: .centerY, relatedBy: .equal, toItem: CAppdelegate?.window, attribute: .centerY, multiplier: 1.0, constant: 0.0).isActive  = true
    }
