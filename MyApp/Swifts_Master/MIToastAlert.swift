...
extension MIToastAlert {
    ...
    func showToastAlert(position:MIToastAlert.MIToastAlertPosition , message:String) {
        ...
        if let toastAlertView = CTopMostViewController.view.viewWithTag(200) {
    ...
    private func resizeToastalertView(position:MIToastAlertPosition) {
        ...
        NSLayoutConstraint(item: MIToastAlert.toastAlertView, attribute: .centerX, relatedBy: .equal, toItem: CAppdelegate?.window, attribute: .centerX, multiplier: 1.0, constant: 0.0).isActive = true
        ...
        NSLayoutConstraint(item: MIToastAlert.toastAlertView, attribute: toastAlertViewAttribute, relatedBy: .equal, toItem: CAppdelegate?.window, attribute: appWindowAttribute, multiplier: 1.0, constant: constant).isActive = true
